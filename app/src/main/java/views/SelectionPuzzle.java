...
public class SelectionPuzzle extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    public static final String SELECTION_PUZZLE = "Selection Puzzle";
    ...
    public static Intent makeIntent(Context context) {
        Intent intent = new Intent(context, SelectionPuzzle.class);
        return intent;
    }
